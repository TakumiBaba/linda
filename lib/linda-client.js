(function() {
  ...
  TupleSpace = (function() {
    ...
    TupleSpace.prototype.option = function(opt) {
      return {
        write: (function(_this) {
          return function(tuple, option) {
            var k, v;
            for (k in option) {
              v = option[k];
              opt[k] = v;
            }
            return _this.write(tuple, opt);
          };
        })(this),
        read: (function(_this) {
          return function(tuple, callback) {
            return _this._read(tuple, opt, callback);
          };
        })(this),
        take: (function(_this) {
          return function(tuple, callback) {
            return _this._take(tuple, opt, callback);
          };
        })(this),
        watch: (function(_this) {
          return function(tuple, callback) {
            return _this._watch(tuple, opt, callback);
          };
        })(this)
      };
    };
    ...
    TupleSpace.prototype._take = function(tuple, option, callback) {
    ...
    TupleSpace.prototype._read = function(tuple, option, callback) {
      var id, listener, name;
      id = this.create_callback_id();
    ...
    TupleSpace.prototype.watch = function(tuple, callback) {
      ...
      return this.option({}).watch(tuple, callback);
    };

    TupleSpace.prototype._watch = function(tuple, option, callback) {
      var id, listener, name;
