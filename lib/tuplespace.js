(function() {
  ...
  module.exports = TupleSpace = (function() {
    ...
    TupleSpace.prototype.read = function(tuple, option, callback) {
      var i, id, seq, t, _i, _j, _k, _len, _ref, _ref1, _results, _results1;
      ...
      seq = option.sort === 'queue' ? (function() {
        _results = [];
        for (var _i = 0, _ref = this.size - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; 0 <= _ref ? _i++ : _i--){ _results.push(_i); }
        return _results;
      }).apply(this) : (function() {
        _results1 = [];
        for (var _j = _ref1 = this.size - 1; _ref1 <= 0 ? _j <= 0 : _j >= 0; _ref1 <= 0 ? _j++ : _j--){ _results1.push(_j); }
        return _results1;
      }).apply(this);
    ...
    TupleSpace.prototype.take = function(tuple, option, callback) {
      var i, id, seq, t, _i, _j, _k, _len, _ref, _ref1, _results, _results1;
      if (typeof option === 'function') {
        callback = option;
        option = {};
